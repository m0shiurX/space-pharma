            ...
            <div class="px-4 md:px-8 xl:px-10 rounded-lg">
                <form class="" @submit.prevent="saveItem">
                    <div class="mx-auto w-2xl max-w-lg">
                        ...
                        <p class="hidden mt-2 text-lg">Please fill in the details below so that we can get in contact
                            with you.
                        </p>
                        <div class="mt-6">
                            ...
                            <div class="bg-orange-100 mb-3 w-full">
                                <v-select class="h-full" placeholder="Choose a Manufacturer"
                                    v-model="form.manufacturer_id" :options="props.manufacturers"
                            ...
                            <div class="flex justify-end items-center space-x-5 mt-8">
                                ...
                                <button @click="saveItem" class="bg-orange-500 px-8 py-2 rounded-md text-white"
